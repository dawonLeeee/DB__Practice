 ...
 * 		지정된 범위 내에서 일정한 간격으로 증가하는 숫자가 출력됨
 * 
 ...
 * SEQUENCE는 주로 PK역할의 컬럼에 삽입되는 값을 만드는 용도로 사용(인위적 주 식별자)
  ...
  [CYCLE | NOCYCLE] -- 값 순환 여부 지정 (NOCYCLE이 기본값)
...
-- EMP_TEMP테이블에 사원 정보 삽입
INSERT INTO EMP_TEMP VALUES(
SEQ_TEMP.NEXTVAL, '홍길동');


INSERT INTO EMP_TEMP VALUES(
SEQ_TEMP.NEXTVAL, '고길동'
);

INSERT INTO EMP_TEMP VALUES(
SEQ_TEMP.NEXTVAL, '김길동'
);
